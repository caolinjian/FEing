    ...
    function(node, attribute) {
      ...
      if (ATTR_DEFAULT[attribute]) {
        return attribute == 'value' ?
          obj && obj.specified :
          !!node[ATTR_DEFAULT[attribute]];
      }
      return !!(obj && obj.specified);
    },
...
//          expr = 'm=s.hasAttribute(e,"' + match[1] + '");if(m){n=s.' + (match[2] ? 'get' : 'has') +
//            'Attribute(e,"' + match[1] + '")' +
//            (type && match[2] ? '.toLowerCase();' : ';') + '}';
//
//          source = expr + 'if(m||n==""){if(' + (match[2] ? test : 'n') + '){' + source + '}}';
